    ...
    <body>
        <?php
            ...
            if($resultado == false){
                ...
                echo '<form actcion="alterar.php method="GET">
                        <table>
                            <thead>
                                <tr>
                                    <th>ID</th>
                ...
                if($_GET){
                    if(isset($_GET['id'])){
                        ...
                        echo '<h2>Atualizar Informações</h2>
                ...
                if($_POST['alterar']){
                    $resultadoAlteracao = $EmpresaDAO->alterar($id, $cnpj, $razaoSocial, $nomeFantasia, $endereco, $bairro, $cidade, $contato, $telefone, $celular, $status, $observacao);
